...
yay --noconfirm -S mons i3-gaps pa-applet-git cava polybar-git ttf-font-awesome-4 advcp wmfocus fzf polybar-git ly-git i3lock-fancy scrot mons xorg-xpdyinfo ytop bat
