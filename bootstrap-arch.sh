...
# Deploy environment
yay --noconfirm -S i3-wm zsh neovim neovide ranger slock qutebrowser python-adblock dmenu rofi rofi-calc rofi-pass rofi-power-menu keychain udiskie picom playerctl pasystray blueman feh ripgrep entr mupdf mupdf-tools dunst fzf fd mpd mpdris2 mpc ncmpcpp w3m libcaca imv nnn lf vlock numlockx xdotool yad kitty tor lxappearance udiskie xorg-xinput ncdu thunderbird-beta-bin adapta-gtk-theme arc-gtk-theme net-tools mpv mpv-mpris xorg-xrdb neofetch rsync openvpn networkmanager-openvpn network-manager-applet man xdo mons pa-applet-git cli-visualizer advcp wmfocus ly i3lock-fancy maim flameshot xorg-xdpyinfo btop bat xorg-xrandr arandr pywal gucharmap pipewire pipewire-pulse pipewire-alsa pavucontrol pulsemixer pamixer youtube-dl gst-plugins-{base,good,bad,ugly} gst-libav figlet exa tokei procs zsh-syntax-highlighting zsh-autosuggestions zsh-history-substring-search i3blocks i3blocks-contrib kbdd sysstat xorg-xbacklight brightnessctl hsetroot cowsay lolcat fortune-mod rpg-cli git-delta xob python-watchdog python-pulsectl nsxiv autotiling mailcap run-mailcap viu zathura chafa ueberzug noto-fonts-emoji starship stylua prettier
