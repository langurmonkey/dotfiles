...
return packer.startup(function(use)
  ...
  use "akinsho/bufferline.nvim" -- Show buffers as tabs
  use "moll/vim-bbye"
  use "nvim-lualine/lualine.nvim" -- A basic status line
  ...
  use "simrat39/symbols-outline.nvim" -- Outline view using LSP
