...
hl.animation({ leaf = "windows",       enabled = true,  speed = 3.79, spring = "easy" })
hl.animation({ leaf = "windowsIn",     enabled = true,  speed = 3.1,  spring = "easy",         style = "popin 87%" })
...
hl.animation({ leaf = "workspacesIn",  enabled = true,  speed = 0.21, bezier = "almostLinear", style = "fade" })
